...
class SideboardContent(BaseModel):
    ...
    type: str = Field(
        "text", description="Type of content (text, markdown, html, etc.)"
    )
    actions: Optional[List[Dict[str, Any]]] = Field(
        None, description="List of action buttons/links to display"
    )
...
class SideboardDisplayTool(BaseTool):
    ...
    description: str = (
        "Use this tool to update the sideboard with relevant information or actions."
    )
