...
class ContextualInputToolInput(BaseModel):
    ...
    input_type: str = Field(..., description="Type of input (e.g., 'text', 'email', 'number')")
...
class ContextualInputModuleTool(BaseTool):
    ...
    description: str = "Use this tool when you need to collect specific information from the user via a form input."
    args_schema: type[BaseModel] = ContextualInputToolInput
    
    def _run(self, input_type: str, label: str, required: bool = True, placeholder: str = None) -> Dict[str, Any]:
